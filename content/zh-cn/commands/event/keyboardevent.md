...
![alt text](/image/zh-cn/commands/event/keyboardevent/image.png)

![alt text](/image/zh-cn/commands/event/keyboardevent/image-1.png)

## 按键模式

支持绑定单按键以及多按键，根据实际情况进行选择即可。

![alt text](/image/zh-cn/commands/event/keyboardevent/image-2.png)
...
![alt text](/image/zh-cn/commands/event/keyboardevent/image-3.png)
