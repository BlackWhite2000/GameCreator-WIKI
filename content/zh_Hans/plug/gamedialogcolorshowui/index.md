...
![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-2.png)
...
![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-3.png)
...
![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-4.png)
...
![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-5.png)

### 最终：显示对话的内容

基于以上的步骤，那么这句话的 `鼠标悬停到这句话` 将会拥有悬浮框的效果。

![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-6.png)
...
![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-7.png)

之后需要在悬浮框界面中创建名为 `dialogImage_0`、`dialogText_0` 的组件。

0 是编号，对应列表中前面的数字

![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-8.png)

![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-9.png)
...
![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-13.png)

考虑到个别情况可能对话框不一定在最前方，如对话菜单在最前方情况。

因此可以设置白名单，指定的界面最前方显示时，悬浮框依然显示。

![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-14.png)
...
![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-11.png)
...
![alt text](/image/zh_hans/plug/gamedialogcolorshowui/index/image-12.png)
