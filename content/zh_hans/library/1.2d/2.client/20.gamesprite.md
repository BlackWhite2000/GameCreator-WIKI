...
- `继承` → Sprite
- `子类` [GCAnimation](../client/gcanimation)、[Avatar](../client/avatar)、[ClientSceneLayer](./clientscene)、[GameImageLayer](./gameimagelayer)、[GameLayer](./gamelayer)
...
| **[setMaterialsByGameSprite](#setmaterialsbygamesprite)**(gameSprite : GameSprite,  cloneMode : boolean): void<br>设置为指定的GameSprite相同的材质                                                                  |
