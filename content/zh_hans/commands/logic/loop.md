...
![alt text](/image/zh_hans/commands/logic/loop/image.png)
...
![alt text](/image/zh_hans/commands/logic/loop/image-1.png)

遇到这种情况可以考虑使用指令 [事件页片段#独立事件片段]() 或者指令 [调用事件库#独立事件]()

![alt text](/image/zh_hans/commands/logic/loop/image-2.png)
