...
![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/commands/system/silentoverload/image.png)

无需其他设置，直接在需要的地方执行即可。

![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/commands/system/silentoverload/image-1.png)
