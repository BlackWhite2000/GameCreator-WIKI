...
![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/6.assets/1.index/image-1.png)

![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/6.assets/1.index/image.png)

![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/6.assets/1.index/image-2.png)
...
![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/6.assets/1.index/image-3.png)
