...
场景对象可以摆放在场景上面，比如作为NPC或装饰甚至是放置在场景上的界面等等（概念详情可以参考 [场景对象](./scene/object)）
...
- API-单机版-场景基类: Scene
- API-单机版-客户端场景类: ClientScene
- API-单机版-客户端场景图层类: ClientSceneLayer
- API-单机版-客户端镜头类: Camera
- API-网络版-场景基类: Scene
- API-网络版-客户端场景类: ClientScene
- API-网络版-服务端场景类: ServerScene
- API-网络版-客户端场景图层类: ClientSceneLayer
- API-网络版-客户端镜头类: Camera
