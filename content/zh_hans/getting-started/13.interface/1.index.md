...
![alt text](/image/zh_hans/getting-started/13.interface/1.index/image.png)
...
![alt text](/image/zh_hans/getting-started/13.interface/1.index/image-1.png)
...
::callout{icon="i-heroicons-light-bulb"}
<br>比如部分模板中的系统设置界面，绑定了名为GUI_Setting的用户自定义类。
