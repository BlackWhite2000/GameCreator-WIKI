...
- 概念：场景对象
- API-通用-场景对象基类: SceneObject
- API-通用-场景对象实体类: SceneObjectEntity
- API-客户端-场景对象类: ClientSceneObject
- API-服务端-场景对象类: ServerSceneObject
...
![alt text](/image/zh_hans/getting-started/7.sceneobject/10.script/image.png)
