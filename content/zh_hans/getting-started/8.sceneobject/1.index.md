...
::div{class="flex"}
  ::div{class="w-[120px]"}
  ![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-2.png)
  ::

  ::div{class="w-[120px]"}
  ![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-1.png)
  ::

  ::div{class="w-[120px]"}
  ![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image.png)
  ::
::
...
![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-3.png)
...
![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-4.png)
...
![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-5.png)

![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-6.png)
...
![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-7.png)
...
![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-8.png)

![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-9.png)
...
![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-10.png)
...
![alt text](/image/zh_hans/getting-started/7.sceneobject/1.index/image-11.png)

## 脚本参考资料

- API-单机版-场景对象基类: SceneObject
- API-单机版-场景对象实体类: SceneObjectEntity
- API-单机版-场景对象行为基类: SceneObjectBehaviors
- API-单机版-客户端场景对象类: ClientSceneObject
- API-网络版-场景对象基类: SceneObject
- API-网络版-场景对象实体类: SceneObjectEntity
- API-网络版-场景对象行为基类: SceneObjectBehaviors
- API-网络版-客户端场景对象类: ClientSceneObject
- API-网络版-服务端场景对象类: ServerSceneObject
