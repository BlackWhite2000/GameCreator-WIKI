...
![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/9.avatar/1.index/image.png)
...
![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/9.avatar/1.index/image-1.png)
...
::div{class="w-1/2"}
![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/9.avatar/1.index/image-3.png)
::

> 下图展示了选择图片中的一小部分切图作为当前帧显示，比如裁剪了头部

::div{class="w-1/2"}
![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/9.avatar/1.index/image-4.png)
::

::div{class="w-1/2"}
![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/9.avatar/1.index/image-5.png)
::
...
![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/9.avatar/1.index/image-6.png)

## 合图工具

如果素材是由多张图片组成的，可以使用内置的合图工具合成一张图集，以便优化加载速度和提升性能。

![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/9.avatar/1.index/image-7.png)
...
![alt text](https://oss.gcw.wiki/GCW/image/zh_hans/getting-started/9.avatar/1.index/image-8.png)
